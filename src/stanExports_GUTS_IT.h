...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(167, 33, "end", "/include/data_guts.stan");
    reader.add_event(167, 56, "restart", "model_GUTS_IT");
    reader.add_event(258, 147, "include", "/include/gen_quantities_guts.stan");
    reader.add_event(258, 0, "start", "/include/gen_quantities_guts.stan");
    reader.add_event(279, 21, "end", "/include/gen_quantities_guts.stan");
    reader.add_event(279, 148, "restart", "model_GUTS_IT");
    reader.add_event(283, 150, "end", "model_GUTS_IT");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mw_log10,(mwMean_log10 + (mwSD_log10 * get_base1(sigma, 3, "sigma", 1))));
            ...
            if (stan::math::is_uninitialized(hb)) {
                ...
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable hb: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 221;
